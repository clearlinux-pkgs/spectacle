...
Version  : 18.08.3
Release  : 1
URL      : https://download.kde.org/stable/applications/18.08.3/src/spectacle-18.08.3.tar.xz
Source0  : https://download.kde.org/stable/applications/18.08.3/src/spectacle-18.08.3.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1541719325
mkdir -p clr-build
pushd clr-build
%cmake ..
