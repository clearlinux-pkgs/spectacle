...
Source0  : https://download.kde.org/stable/release-service/23.08.5/src/spectacle-23.08.5.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.5/src/spectacle-23.08.5.tar.xz.sig
...
%prep
%setup -q -n spectacle-23.08.5
cd %{_builddir}/spectacle-23.08.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708367951
mkdir -p clr-build
pushd clr-build
...
%files
%defattr(-,root,root,-)
/V3/usr/lib64/kconf_update_bin/spectacle-migrate-rememberregion
/V3/usr/lib64/kconf_update_bin/spectacle-migrate-shortcuts
