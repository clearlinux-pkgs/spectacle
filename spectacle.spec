...
Source0  : https://download.kde.org/stable/release-service/22.04.3/src/spectacle-22.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.3/src/spectacle-22.04.3.tar.xz.sig
...
%prep
%setup -q -n spectacle-22.04.3
cd %{_builddir}/spectacle-22.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657552896
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/spectacle-22.04.3/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/spectacle/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/spectacle-22.04.3/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/spectacle/f1946dab78e58c04c8c25ec6b074f5fc5c2830fe
cp %{_builddir}/spectacle-22.04.3/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/spectacle/ee03d68f6be20b170e5ea5d114d6acafb3f2d1dc
cp %{_builddir}/spectacle-22.04.3/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/spectacle/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/spectacle-22.04.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/spectacle/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/spectacle-22.04.3/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/spectacle/5c6c38fa1b6ac7c66252c83d1203e997ae3d1c98
cp %{_builddir}/spectacle-22.04.3/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/spectacle/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/spectacle-22.04.3/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/spectacle/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
cp %{_builddir}/spectacle-22.04.3/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/spectacle/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/spectacle-22.04.3/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/spectacle/7d9831e05094ce723947d729c2a46a09d6e90275
pushd clr-build
%make_install
popd
